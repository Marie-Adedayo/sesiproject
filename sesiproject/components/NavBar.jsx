            ...
            >
              <div className='flex  flex-col md:flex-row'>
                <ul className="flex flex-col md:flex-row w-full items-center justify-center md:items-end md:justify-end md:gap-4 md:h-auto mt-0 md:mt-4 ">
                  <li className="pb-6 text-2xl font-neuemachina font-light text-custom-green py-2 md:px-6 text-center hover:underline hover:decoration-custom-orange hover:underline-offset-2">
                    <Link href="/about" onClick={() => setNavbar(!navbar)}>
                      About
                    </Link>
                  </li>
                  <li className="pb-6 text-2xl font-neuemachina font-light text-custom-green py-2 md:px-6 text-center md:hover:underline md:hover:decoration-custom-orange md:hover:underline-offset-2">
                ...
                <div className="flex justify-center md:justify-start">
                  <Link href="/">
                    <button className="bg-custom-grey text-xl text-custom-orange px-4 py-2 border-2 rounded-l-full rounded-r-full border-custom-orange rounded-2xl md:mt-4 hover:bg-custom-orange hover:text-custom-white">
                      CONTACT
                    </button>
                  </Link>
                </div>
